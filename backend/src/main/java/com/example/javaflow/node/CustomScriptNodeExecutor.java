...
/**
 * Executor for custom script nodes (using JavaScript via GraalVM).
 * This is similar to TransformNodeExecutor but might have different configuration.
 */
public class CustomScriptNodeExecutor implements NodeExecutor {
